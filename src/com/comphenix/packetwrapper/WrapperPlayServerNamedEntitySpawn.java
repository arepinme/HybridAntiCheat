...
public class WrapperPlayServerNamedEntitySpawn extends AbstractPacket {
	...
	public String getPlayerUUID() {
		return handle.getUUIDs().read(0).toString();
	}
	...
	public void setPlayerUUID(String uuid) {
		handle.getUUIDs().write(0, UUIDTypeAdapter.fromString(uuid));
	}
	 ...
	 * <p>
	 * Note that this should be 0 for "no item", unlike -1 used in other packets. A
	 * negative value crashes clients.
	 * 
	 ...
	 * <p>
	 * Note that the 1.3 client crashes on packets with no metadata, but the server
	 * can send any metadata key of 0, 1 or 8 and the client is fine.
	 * 
